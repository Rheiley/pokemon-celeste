...
class Battle::Move
  ...
  def pbCalcDamageMultipliers(user, target, numTargets, type, power, multipliers)
#=============================================================================
...
#=============================================================================
  ...
  fieldEffects_pbCalcDamageMultipliers(user, target, numTargets, type, power, multipliers)
  end	
end
