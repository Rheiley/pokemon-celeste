...
#============================================================================= 01 Electric Terrain
	if [:ElectricTerrain, :ElectricField].include?(@battle.field.terrain) && [:Rain, :HeavyRain].include?(target.effectiveWeather) && defType == :GROUND && moveType == :ELECTRIC
...
#============================================================================= 05 Electric Field
	if [:ElectricField].include?(@battle.field.terrain) && [:EXPLOSION, :SELFDESTRUCT, :SURF, :MUDDYWATER, :HURRICANE, :SMACKDOWN, :THOUSANDARROWS].include?(@id) && GameData::Type.exists?(:ELECTRIC)
