...
ItemHandlers::UseOnPokemon.add(:NATUREMACHINE, proc { |item, qty, pkmn, scene, pkmnid, heldpoke, settingUpBattle, screen|
  commands = []
  ids = []
  ...
  cmd = scene.pbShowCommands(_INTL("Select a new nature..\n#{msg}", pkmn.name), commands, 0)
